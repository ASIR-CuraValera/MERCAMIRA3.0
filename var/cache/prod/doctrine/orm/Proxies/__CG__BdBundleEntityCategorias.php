 ...
 */
class Categorias extends \BdBundle\Entity\Categorias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BdBundle\\Entity\\Categorias' . "\0" . 'categoriaid', '' . "\0" . 'BdBundle\\Entity\\Categorias' . "\0" . 'nombreCategoria'];
        }
